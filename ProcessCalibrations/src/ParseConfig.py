...
class ParseConfig(object):
    ...
    def _getArguments(self):
        ...
        parser = argparse.ArgumentParser(
            description='Code used to process calibrations')
        ...
        parser.add_argument('-caltype',
                            action='store',
                            default='sine,step,random',
        ...
        parser.add_argument('-duration',
                            ...
                            default='0',
                            help='''(Optional) Manual override
                              for calibration duration in seconds.''',
                            type=str,
                            required=False)
        # Manual override for input data location
        parser.add_argument('-inputloc',
                            action='store',
                            default=None,
                            help='''(Optional) Manual override
                              for input data location.''',
                            type=str,
                            required=False)
        # Manual override for inumpyut data location
        parser.add_argument('-outputloc',
                            action='store',
                            default=None,
                            help='''(Optional) Manual override
                              for output data location.''',
                            type=str,
                            required=False)
        ...
        parser.add_argument('-cr',
                            action='store',
                            default='R',
                            help='''(Optional) Manual override for
                              capacitive vs. resistive random calibration.
                              {C = capacitive, R = resistive}.''',
                            type=str,
                            required=False)
